...
"""Comprehensive test suite for IssueSpecOutputParser with pytest spec.

This module tests the IssueSpecOutputParser implementation with pytest output including:
